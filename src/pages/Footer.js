      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:"24px",maxWidth:"1200px",margin:"0 auto"}}>
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:"12px"}}>
          ...
          <div>
            <div style={{fontWeight:600,fontSize:"0.85rem",color:"rgba(255,255,255,0.6)",marginBottom:"4px"}}>EMAIL</div>
              ...
              href="mailto:courriel@ya-consulting.com"
              target="_blank"
              rel="noreferrer"
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:"12px"}}>
          ...
          <div>
            <div style={{fontWeight:600,fontSize:"0.85rem",color:"rgba(255,255,255,0.6)",marginBottom:"4px"}}>TÉLÉPHONE</div>
              ...
              href="tel:+2250152226312"
              style={{color:"white",textDecoration:"none",fontSize:"0.95rem",fontWeight:500,display:"block",marginBottom:"4px"}}
            >
              +225 01 52 22 63 12
            </a>
            
              href="tel:+2250565246974"
              style={{color:"rgba(255,255,255,0.7)",textDecoration:"none",fontSize:"0.9rem",display:"block"}}
            >
              +225 05 65 24 69 74
            </a>
          </div>
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:"12px"}}>
          ...
          <div>
            ...
            <div style={{color:"white",fontSize:"0.9rem",fontWeight:500,lineHeight:"1.6"}}>
              Riviera Palmeraie, en face<br/>
              de la Pharmacie rue Ministre<br/>
              Cocody, Abidjan
            </div>
            
              href="https://www.google.com/maps/search/Riviera+Palmeraie+Pharmacie+Ministre+Cocody+Abidjan/@5.3657,−3.9693,15z"
              target="_blank"
              rel="noreferrer"
              style={{color:"rgba(255,255,255,0.6)",fontSize:"0.82rem",textDecoration:"none",marginTop:"4px",display:"block"}}
            >
              Voir sur la carte →
            </a>
          </div>
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:"12px"}}>
          ...
          <div>
            <div style={{fontWeight:600,fontSize:"0.85rem",color:"rgba(255,255,255,0.6)",marginBottom:"4px"}}>SITE WEB</div>
              ...
              href="https://www.ya-consulting.com"
              target="_blank"
              rel="noreferrer"
              style={{color:"white",textDecoration:"none",fontSize:"0.95rem",fontWeight:500}}
            >
